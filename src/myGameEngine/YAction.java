...
public class YAction extends AbstractInputAction {
	...
	public YAction(SceneNode a, float s, int dir, TerrainBlock terrain, Client client) 
	{ 
		avatar = a; 
		speed = s; 
		direction = dir;
	...
	{ 
		...
		//((Model3DTriMesh) avatar).stopAnimation();
		//((Model3DTriMesh) avatar).startAnimation("walk");
	}
